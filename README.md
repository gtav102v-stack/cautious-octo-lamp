  ...
  <style>
    ...
    *{box-sizing:border-box}
    ...
    body {
      ...
      color: #fff;
      background:
        radial-gradient(1200px 800px at 15% 25%, rgba(46,26,71,0.35), transparent 60%),
        radial-gradient(900px 700px at 85% 70%, rgba(11,42,79,0.35), transparent 60%),
        radial-gradient(700px 600px at 60% 20%, rgba(22,34,59,0.25), transparent 70%),
        radial-gradient(1000px 1000px at 50% 50%, rgba(255,255,255,0.05), transparent 70%),
        var(--space-bg);
      min-height: 100svh;
    }
